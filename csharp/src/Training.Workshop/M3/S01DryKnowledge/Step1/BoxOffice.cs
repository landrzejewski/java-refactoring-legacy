namespace Training.Workshop.M3.S01DryKnowledge.Step1;

/// <summary>
/// Krok 1: Extract Method - blok "ile kosztował bilet" w zwrocie dostaje nazwę
/// <c>PaidFor</c>. Duplikat wiedzy staje się widoczny: dwie metody odpowiadają
/// na to samo pytanie "ile kosztuje ten bilet?".
/// </summary>
public sealed class BoxOffice
{
    ...
    private static decimal PaidFor(Ticket ticket)
    {
        var paid = 25.00m;
        if (ticket.Format == "3D")
        {
