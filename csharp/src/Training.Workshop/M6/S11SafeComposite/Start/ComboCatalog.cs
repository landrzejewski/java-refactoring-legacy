...
/// <summary>Start: klient typuje wszystko jako MenuComponent, bo Add() jest wszędzie.</summary>
public sealed class ComboCatalog
{
    ...
    {
        MenuComponent combo = new Combo("Zestaw Rodzinny");
        combo.Add(new Product("Popcorn XL", "24.00"));
        MenuComponent drinks = new Combo("Napoje");
    ...
    {
        MenuComponent combo = new Combo("Zestaw Duo");
