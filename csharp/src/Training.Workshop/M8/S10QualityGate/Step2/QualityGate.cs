...
namespace Training.Workshop.M8.S10QualityGate.Step2;

/// <summary>
/// Krok 2: + ostrzeżenia kompilatora (Roslyn w pamięci, nullable, wszystkie fale ostrzeżeń). Każde
/// ostrzeżenie to wynik z identyfikatorem i pozycją; bramka nie przepuszcza nowych ostrzeżeń w domenie.
/// </summary>
