using Training.Workshop.M7.S13GodClass.Step1;

namespace Training.Workshop.Tests.M7.S13GodClass.Step1;

/// <summary>Adapter wariantu step1 dla S13Script (InternalsVisibleTo - dostęp do haka CinemaManager.Clock).</summary>
