using Training.Workshop.M7.S13GodClass.Step3;

namespace Training.Workshop.Tests.M7.S13GodClass.Step3;

/// <summary>Adapter wariantu step3 dla S13Script (InternalsVisibleTo - dostęp do haka CinemaManager.Clock).</summary>
