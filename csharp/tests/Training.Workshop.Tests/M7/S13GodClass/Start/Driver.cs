using Training.Workshop.M7.S13GodClass.Start;

namespace Training.Workshop.Tests.M7.S13GodClass.Start;

/// <summary>Adapter wariantu start dla S13Script (InternalsVisibleTo - dostęp do haka CinemaManager.Clock).</summary>
