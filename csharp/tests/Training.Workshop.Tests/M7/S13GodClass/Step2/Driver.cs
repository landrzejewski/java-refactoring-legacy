using Training.Workshop.M7.S13GodClass.Step2;

namespace Training.Workshop.Tests.M7.S13GodClass.Step2;

/// <summary>Adapter wariantu step2 dla S13Script (InternalsVisibleTo - dostęp do haka CinemaManager.Clock).</summary>
