...
/**
 * Krok 3 (bez zmian): stary cennik za abstrakcją TicketPricing. Wnętrze bez zmian,
 * jedynie na granicy zamieniamy double na Money (adapter do nowego kontraktu).
 */
public final class LegacyTicketPricing implements TicketPricing {
    @Override
    public Money total(BookingRequest request) {
        ...
        return new Money(BigDecimal.valueOf(total));
    }
}
