package pl.training.workshop.m4.s05_inlinevariable.step2;
...
/**
 * Krok 2: Inline Variable {@code holdUntil} - bezpieczny, bo inicjalizator czyta ZMIENNĄ issuedAt,
 * a nie zegar. Zmiennych number i issuedAt nie wolno wkleić: każde użycie wywołałoby
 * nextNumber() albo clock.instant() od nowa.
 */
