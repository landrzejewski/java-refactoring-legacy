package pl.training.workshop.m4.s03_magicnumbers.step3;
 ...
 * Stałe są prywatne - publiczne {@code static final int} kompilator wkleja do klientów.
 */
public final class OrderPricer {
    ...
    private static final BigDecimal STUDENT_DISCOUNT = new BigDecimal("0.25");
    private static final BigDecimal SENIOR_DISCOUNT = new BigDecimal("0.30");
    private static final BigDecimal CHILD_DISCOUNT = new BigDecimal("0.40");
    ...
    public String summary(Order o) {
        ...
        for (Ticket t : o.tickets()) {
            ...
            if (t.type().equals("S")) {
                ...
                p = p.multiply(BigDecimal.ONE.subtract(CHILD_DISCOUNT));
            }
