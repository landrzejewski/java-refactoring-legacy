...
/**
 * Start: raport obłożenia sali. Woła przestarzałe PriceTable.basePrice(number) (deprecation)
 * i celowo "przelatuje" z IMAX do 3D w switch (fallthrough) - IMAX ma też dźwięk Dolby.
 * Build projektu ma noFallthroughCasesInSwitch, więc przelot wyciszono dyrektywą @ts-expect-error.
 */
