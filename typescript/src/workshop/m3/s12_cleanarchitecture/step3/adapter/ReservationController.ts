...
import { OutboxBookingNotifier } from './OutboxBookingNotifier.js';
import { RowStoreReservationStore } from './RowStoreReservationStore.js';

/**
 * Adapter wejściowy: tłumaczy parametry na `BookSeatsCommand`, wynik i wyjątki
