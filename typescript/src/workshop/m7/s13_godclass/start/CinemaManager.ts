...
/**
 * Start: KOPIA legacy CinemaManager (wraz z LegacyDb, LegacyMailer, LegacyPaymentGateway),
 * na której prowadzimy kampanię Remove God Class. Klasa robi wszystko: rezerwacje, cennik,
 * płatności, zwroty, lojalność, powiadomienia, raporty i rozliczenia. Każdy krok wycina
 * JEDEN pionowy fragment, a S13GoldenMasterTest pilnuje identycznego wektora zachowania.
 */
