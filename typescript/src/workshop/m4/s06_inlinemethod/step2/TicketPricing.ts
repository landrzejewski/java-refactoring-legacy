...
/**
 * Krok 2 (rozwiązanie): Inline Method `addFee`. Wklejamy WYWOŁANIE `bookingFee()`,
 * więc dynamiczna dyspozycja zostaje i OnlineTicketPricing nadal dolicza 2.00.
 * `bookingFee` NIE inline'ujemy: wklejenie jego ciała z klasy bazowej zabiłoby nadpisanie.
 */
