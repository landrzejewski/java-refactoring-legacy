...
/**
 * Krok 1: przygotowanie "refleksji" PRZED ruchem w hierarchii - przegląd całego łańcucha prototypów
 * widzi też metody odziedziczone (odpowiednik getMethods()). Wynik bez zmian, ale kod jest gotowy na Pull Up.
 */
