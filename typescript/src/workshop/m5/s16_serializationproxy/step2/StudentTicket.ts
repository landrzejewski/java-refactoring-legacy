...
/**
 * Krok 2: Serialization Proxy - do JSON trafia płaska postać SerializedForm (toJSON), a odczyt
 * przechodzi przez fromJSON i publiczny konstruktor. Hierarchia klasy przestaje być formatem danych.
 * Wersja formatu v = 2 to świadoma deklaracja nowego formatu: stare dane są odrzucane głośno
 * (InvalidClassError) zamiast po cichu gubić pola - ich migracja to osobne zadanie.
 */
