import { CinemaManager } from '../../../../../src/workshop/m7/s13_godclass/start/CinemaManager.js';
import { LegacyDb } from '../../../../../src/workshop/m7/s13_godclass/start/LegacyDb.js';
import { LegacyMailer } from '../../../../../src/workshop/m7/s13_godclass/start/LegacyMailer.js';
import { LegacyPaymentGateway } from '../../../../../src/workshop/m7/s13_godclass/start/LegacyPaymentGateway.js';
import type { LocalDate, LocalDateTime } from '../../../../../src/workshop/shared/time.js';
import type { CinemaUnderTest } from '../CinemaUnderTest.js';

/** Adapter wariantu start dla S13Script (dostęp do haka CinemaManager.clock i globalnego stanu). */
